[![Banner](https://i.imgur.com/pjha5cv.png)](https://github.com/YourUsername/GreekDownloader)

# GreekDownloader

Downloads a variety of content from the web, primarily YouTube videos.
It can also downloaad **Instagram** videos.

## Features
- **Downloads from 1,800+ sites** via yt-dlp - YouTube, Vimeo, TikTok, Twitch, Twitter/X, and more - plus direct file links (video, audio, images). DRM services like Netflix and Disney+ aren't supported.
